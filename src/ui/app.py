...
from src.ui.screens import (
    BaselineScreen, HubScreen, SettingsScreen,
    StatisticsScreen, DetectionScreen, AlertPopup
)
...
class BarorokApp:
    ...
    def _setup_screens(self):
        ...
        self.statistics_screen = StatisticsScreen(self.theme_manager, self.session_manager)
        ...
        self.hub_screen.start_detection_signal.connect(
        ...
        self.detection_screen.detection_stopped_signal.connect(
